<?php
	...
	if(isset($_GET["check"])){
			...
			if($_POST["paleti"] == ""){
				...
				$butilki_palet = $paleti * 264;
				$butilki_stek = $stekove * 6;
				$obshto_stekove = $paleti * 44 + $stekove;
...
<body>
<div class="main_div">
<form action="index.php?type=2-5_l&check=1" method="post">
<center><h1>2.5 литра</h1></center>
...
<?php// if(isset($success)){echo"<div class=\"success\">$kraen_rezultat</div>";}else{} ?>
    ...
    <br /><br /><br />
    <input class="input_2"  type="submit" value="Давай да даваме! :D" />
</form><br/>
